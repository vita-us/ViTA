...
public class StanfordNLPModuleTest extends NLPTestSetup {

  private static StanfordNLPModule module;
  private static StanfordNLPResult stanfordNLPResult;

  @BeforeClass
  public static void setUp() throws Exception {
    NLPTestSetup.setUp();
    module = new StanfordNLPModule();
    stanfordNLPResult = module.execute(resultProvider, progressListener);
  }

  @Test
  public void testEntityAnnotations() throws Exception {
    Set<Annotation> annotations = stanfordNLPResult.getAnnotationsForChapter(chapterObjects.get(1));
