...
public class Filter {
  ...
  public List<Line> filterEbookText() {
    ...
    // Set the new edited line entry.getValue() in the entireEbookList at the position entry.getKey()
   ...
   */
  private void addElementsToRemoveListAndMap(List<Line> removeList, Map<Integer, Line> defaultCommentMap, Line line) {
    String editedLine;
